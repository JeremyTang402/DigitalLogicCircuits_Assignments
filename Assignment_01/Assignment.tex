...
\begin{enumerate}
    ...
    \item $ [+\textbf{0}]_\text{原} = \textbf{0000\ 0000}, [-\textbf{0}]_\text{原} = \textbf{1000\ 0000} $
\end{enumerate}
}
...
\solution{
\begin{enumerate}
    \item $ N_1 = \textbf{10101011}, [N_1]_{\text{原}} = \textbf{11010100}, [N_1]_{\text{反}} = \textbf{10101011} $
    \item $ N_2 = \textbf{01001010}, [N_2]_{\text{原}} = \textbf{01001010}, [N_2]_{\text{反}} = \textbf{01001010} $
    \item $ N_3 = \textbf{11111111}, [N_3]_{\text{原}} = \textbf{10000000}, [N_3]_{\text{反}} = \textbf{11111110} $
    \item $ N_4 = \textbf{00000000}, [N_4]_{\text{原}} = \textbf{00000000}, [N_4]_{\text{反}} = \textbf{00000000} $
\end{enumerate}
}

\question{2.16}{
计算下列两个无符号数相减的结果，并用十进制表示结果。
\begin{enumerate}
    \item $ \textbf{010101} - \textbf{001101} $
    \item $ \textbf{010001} - \textbf{011010} $
    \item $ \textbf{111010} - \textbf{000101} $
    \item $ \textbf{101010} - \textbf{100101} $
\end{enumerate}
}
...
\begin{enumerate}
    ...
    \begin{array}{rrrrrrrr}
       ...
       -&1&0&0&1&0&1\\
        ...
        &0&0&0&1&0&1
    \end{array} $ \\
    结果：$ (\textbf{000101})_2 = (5)_{10} $
\end{enumerate}
}

\question{2.18}{
假设字长8位，用二进制补码计算下列两个数的 $ A + B $，$ A - B $，$ - A + B $，$ - A - B $，并用十进制数验证，如果结果出现异常，解释原因。
\begin{enumerate}
    \item $ A =\textbf{1010100} \qquad B = \textbf{1011} $
    \item $ A =\textbf{1110100} \qquad B = \textbf{101111} $
    \item $ A =\textbf{1101010} \qquad B = \textbf{0101110} $
    \item $ A =\textbf{1000000} \qquad B = \textbf{0111101} $
\end{enumerate}
}

\solution{
\begin{enumerate}
    \item $ [A]_{\text{补}}=\textbf{0101\ 0100}, [B]_{\text{补}}=\textbf{0000\ 1011} $\\
    $ [A+B]_{\text{补}}=\textbf{0101\ 1111} $\\
    $ [A-B]_{\text{补}}=\textbf{0100\ 1001} $\\
    $ [-A+B]_{\text{补}}=\textbf{1011\ 0111} $\\
    $ [-A-B]_{\text{补}}=\textbf{1010\ 0001} $ \\
    十进制验算：$ A=84, B=11, A+B=95, A-B=73, -A+B=-73, -A-B=-95 $ \\
    均在8位补码范围 $ (-128\sim 127) $ 内，无溢出。

    \item $ [A]_{\text{补}}=\textbf{0111\ 0100}, [B]_{\text{补}}=\textbf{0010\ 1111} $\\
    $ [A+B]_{\text{补}}=\textbf{1010\ 0011} $\\
    $ [A-B]_{\text{补}}=\textbf{0100\ 0101} $\\
    $ [-A+B]_{\text{补}}=\textbf{1011\ 1011} $\\
    $ [-A-B]_{\text{补}}=\textbf{0101\ 1101} $\\
    十进制验算：$ A=116, B=47, A+B=163, A-B=69, -A+B=-69, -A-B=-163 $ \\
    $ A+B=163 $ 与 $ -A-B=-163 $超出8位补码范围 $ (-128\sim 127) $ ，因此发生溢出。

    \item $[A]_{\text{补}}=\textbf{0110\ 1010}, [B]_{\text{补}}=\textbf{0010\ 1110} $\\
    $ [A+B]_{\text{补}}=\textbf{1001\ 1000} $\\
    $ [A-B]_{\text{补}}=\textbf{0011\ 1100} $\\
    $ [-A+B]_{\text{补}}=\textbf{1100\ 0100} $\\
    $ [-A-B]_{\text{补}}=\textbf{0110\ 1000} $\\
    十进制验算：$ A=106, B=46, A+B=152, A-B=60, -A+B=-60, -A-B=-152 $ \\
    $ A+B=152 $ 与 $ -A-B=-152 $ 超出8位补码范围 $(-128\sim127)$，因此发生溢出。

    \item $ [A]_{\text{补}}=\textbf{0100\ 0000}, [B]_{\text{补}}=\textbf{0011\ 1101} $\\
    $ [A+B]_{\text{补}}=\textbf{0111\ 1101} $\\
    $ [A-B]_{\text{补}}=\textbf{0000\ 0011} $\\
    $ [-A+B]_{\text{补}}=\textbf{1111\ 1101} $\\
    $ [-A-B]_{\text{补}}=\textbf{1000\ 0011} $\\
    十进制验算：$ A=64, B=61, A+B=125, A-B=3, -A+B=-3, -A-B=-125 $ \\
    均在8位补码范围 $ (-128\sim 127) $ 内，无溢出。
\end{enumerate}
}

\question{2.20}{
计算下列两个反码相减的结果，并用十进制表示结果（减法变成加法运算）。
\begin{enumerate}
    \item $ \textbf{110011}-\textbf{110110} $
    \item $ \textbf{100110}-\textbf{011000} $
    \item $ \textbf{011010}-\textbf{011110} $
    \item $ \textbf{011111}-\textbf{100011} $
\end{enumerate}
}

\solution{
\begin{enumerate}
    \item $ \textbf{110011} - \textbf{110110} = \textbf{110011} + \textbf{001001} = \textbf{111100}$，十进制表示为 $-3$。

    \item $ \textbf{100110} - \textbf{011000} = \textbf{100110} + \textbf{100111} = \textbf{1,001101}$ \\
    进位：$\textbf{001101} + \textbf{1} = \textbf{001110}$，十进制表示为 $+14$（发生溢出）。

    \item $ \textbf{011010} - \textbf{011110} = \textbf{011010} + \textbf{100001} = \textbf{111011}$，十进制表示为 $-4$。

    \item $ \textbf{011111} - \textbf{100011} = \textbf{011111} + \textbf{011100} = \textbf{111011}$，十进制表示为 $-4$（发生溢出）。
\end{enumerate}
}
% ============================================
